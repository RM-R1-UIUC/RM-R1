...
# Model Setting
MODEL_PATH=distilled_model_dir # You may specify local directory
...
# Logging Setting
PROJECT_NAME=RM-R1 
EXPERIMENT_NAME=RM-R1-Qwen2.5-Instruct-14B-RLVR-after-Distill-LR${LR}
SAVE_NAME=RM-R1-Qwen2.5-Instruct-14B-RLVR-after-Distill-LR${LR}
...
# Task
TRAIN_TASK="gaotang/RM-R1-after-Distill-RLVR"
EVAL_TASK="gaotang/RM-R1-after-Distill-RLVR"
