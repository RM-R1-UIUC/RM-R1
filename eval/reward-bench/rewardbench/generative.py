...
RM_R1_INSTRUCT_SYSTEM_PROMPT = (
    "Please act as an impartial judge and evaluate the quality of the responses provided by two AI Assistants to the User's question displayed below.\n\n"
    ...
    "1. Solve the User's question yourself and present your final answer within <solution>...</solution> tags.\n"
    "2. Evaluate the two Assistant responses based on correctness, completeness, and reasoning quality, referencing your own solution.\n"
    "3. Include your evaluation inside <eval>...</eval> tags, quoting or summarizing the Assistants using the following tags:\n"
    "   - <quote_A>...</quote_A> for direct quotes from Assistant A\n"
    "   - <summary_A>...</summary_A> for paraphrases of Assistant A\n"
    "   - <quote_B>...</quote_B> for direct quotes from Assistant B\n"
    "   - <summary_B>...</summary_B> for paraphrases of Assistant B\n"
    "4. End with your final judgment in the format: <answer>[[A]]</answer> or <answer>[[B]]</answer>\n\n"

    "If the task is Chat:\n"
    "1. Generate evaluation criteria (rubric) tailored to the User's question and context, enclosed in <rubric>...</rubric> tags.\n"
    ...
    "4. Compare both Assistant responses according to the rubric.\n"
    ...
    "- Do not let response order, length, or Assistant names affect your judgment.\n"
...
RM_R1_INSTRUCT_SYSTEM_PROMPT_ORIGINAL = (
...
RM_R1_SINGLE_TURN_INSTRUCT_USER_PROMPT_ORIGINAL = (
...
RM_R1_SINGLE_TURN_REASONING_USER_PROMPT = "Please act as an impartial judge and evaluate the quality of the responses provided by two AI Chatbots to the Client question displayed below. \n\n"
"[Client Question]\n{question}\n\n[The Start of Chatbot A's Response]\n{answer_a}\n[The End of Chatbot A's Response]\n\n"
"[The Start of Chatbot B's Response]\n{answer_b}\n[The End of Chatbot B's Response]" + "\n\n"
