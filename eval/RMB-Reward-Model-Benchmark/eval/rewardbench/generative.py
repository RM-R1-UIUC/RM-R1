...
def format_judge_answers(question, answer_a, answer_b, multi_turn=False, 
    ...
    if model_modifier == "prometheus":
        ...
        if multi_turn:
            ...
            user_prompt = RM_R1_MULTI_TURN_INSTRUCT_USER_PROMPT.format(
                conversation_1=conversation1,
                conversation_2=conversation2,
            )
        else:
            system_prompt = RM_R1_INSTRUCT_SYSTEM_PROMPT
        ...
        if multi_turn:
            ...
            user_prompt = RM_R1_MULTI_TURN_REASONING_USER_PROMPT.format(
                conversation_1=conversation1,
                conversation_2=conversation2,
            )
        else:
