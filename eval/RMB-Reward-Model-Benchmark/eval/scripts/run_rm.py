...
from my_utils.utils import torch_dtype_mapping, load_eval_dataset_rm
...
def get_args():
    ...
    parser.add_argument("--dataset_dir", type=str, default="RMB_dataset/Pairwise_set/Helpfulness", help="path to data_dir",
                        choices=["RMB_dataset/Pairwise_set/Helpfulness", "RMB_dataset/Pairwise_set/Harmlessness"])
...
def main():
    args = get_args()
    if args.dataset_dir == "RMB_dataset/Pairwise_set/Helpfulness":
        args.model_save_meta = "Pairwise_set_Helpfulness"
    else:
        args.model_save_meta = "Pairwise_set_Harmlessness"
    ...
    dataset, subsets = load_eval_dataset_rm(
        core_set=False,
    ...
    print("Final Acc: ", sum(results) / len(results)) 
